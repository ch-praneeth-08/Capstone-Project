...
function ArticleByID() {
  ...
  async function addComment(commentObj) {
    // Attach the current user's name to the comment object
    ...
    try {
      ...
      if (res.data.message === "comment added") {
        setCommentStatus("Comment added successfully!"); // Show success message
  
        // Ensure we update the comments array properly
        setCurrentArticle((prevArticle) => ({
          ...prevArticle,
          comments: res.data.payload.comments ?? prevArticle.comments, // Ensure comments are updated
        }));
      }
    } catch (error) {
  ...
  async function deleteArticle() {
    try {
      ...
      if (res.data.message === "article deleted or restored") {
        setCurrentArticle(res.data.payload); // Update state properly
      }
    } catch (error) {
